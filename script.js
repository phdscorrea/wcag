...
const app = {
    ...
    sidebarLinks: document.querySelectorAll('.sidebar-nav a[href^="#"]'),
    ...
    setupEventListeners() {
        ...
        // Sidebar - fechar ao clicar no botão close
        if (this.sidebarClose) {
            this.sidebarClose.addEventListener('click', () => this.closeSidebar());
        }
        
        // Sidebar - toggle recolher/expandir
        if (this.sidebarToggle) {
            this.sidebarToggle.addEventListener('click', () => this.toggleSidebar());
        }
        
        // Sidebar - navegação ao clicar em links
    ...
    handleScroll() {
        ...
        // Mostrar/ocultar sidebar após scroll
        if (currentScroll > this.config.sidebarScrollThreshold) {
            this.sidebar.classList.add('visible');
        } else {
            this.sidebar.classList.remove('visible');
        }
        
        // Destacar link ativo na navegação e sidebar
    ...
    handleSidebarLinkClick(e) {
        ...
        if (target) {
            ...
            // Em mobile (max-width 768px), fechar sidebar após clicar
